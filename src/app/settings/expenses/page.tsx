...
export default function ExpenseSettingsPage() {
  ...
  const [editingSubcategory, setEditingSubcategory] = React.useState<ExpenseCategory['subcategories'][0] | null>(null);
  ...
  const handleEditSubcategory = (subcategory: ExpenseCategory['subcategories'][0], category: ExpenseCategory) => {
    setEditingSubcategory(subcategory);
    setParentCategory(category);
    setIsSubcategoryDialogOpen(true);
  };

  const handleDeleteSubcategory = (subcategory: ExpenseCategory['subcategories'][0], category: ExpenseCategory) => {
  ...
  return (
    <>
      <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
        <PageHeader title="Cuentas de Gastos">
