...
export default function AssetsPage() {
  ...
  const filteredAssets = React.useMemo(() => {
    ...
    return assets.filter(asset => asset.propertyId === activeAccountId);
        ...
        <Card>
          <CardContent className="p-10 text-center">
            ...
            <h3 className="mt-4 text-lg font-semibold">
              {activeAccountId === 'all' ? 'No tienes activos registrados' : 'No hay activos para esta cuenta'}
            </h3>
            <p className="mt-1 text-sm text-muted-foreground">
              {activeAccountId === 'all' 
                ? 'Comienza añadiendo un préstamo que hayas otorgado u otra cuenta por cobrar.'
                : 'Puedes añadir un activo para esta cuenta o cambiar a "Todas las Cuentas" para ver todos.'
              }
            </p>
