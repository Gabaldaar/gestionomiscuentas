...
export default function LiabilitiesPage() {
  ...
  const filteredLiabilities = React.useMemo(() => {
    ...
    return liabilities.filter(liability => liability.propertyId === activeAccountId);
  }, [liabilities, activeAccountId]);
        ...
        <Card>
          <CardContent className="p-10 text-center">
            ...
            <h3 className="mt-4 text-lg font-semibold">
              {activeAccountId === 'all' ? 'No tienes pasivos registrados' : 'No hay pasivos para esta cuenta'}
            </h3>
            <p className="mt-1 text-sm text-muted-foreground">
              {activeAccountId === 'all'
                ? 'Comienza añadiendo un préstamo, crédito o cualquier otra deuda.'
                : 'Puedes añadir un pasivo para esta cuenta o cambiar a "Todas las Cuentas" para ver todos.'
              }
            </p>
