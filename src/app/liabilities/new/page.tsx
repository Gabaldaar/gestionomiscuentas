...
import { type Wallet, type Property, type IncomeCategory, type IncomeSubcategory } from '@/lib/types';
...
const liabilitySchema = z.object({
  ...
  propertyId: z.string().min(1, "La cuenta propietaria es obligatoria"),
  ...
  message: 'Debes seleccionar una billetera si recibes un monto inicial.',
  path: ['walletId'],
});
            ...
            <ScrollArea className="h-[75vh]">
              ...
              <CardContent className="space-y-6">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Cuenta Propietaria</FormLabel>
                      <Select onValueChange={field.onChange} value={field.value} disabled={activeAccountId !== 'all'}>
                        <FormControl>
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <Select onValueChange={field.onChange} value={field.value}>
                            ...
                            <SelectContent>
                              {wallets.filter(w => w.currency === form.getValues('currency')).sort(sortWallets).map(wallet => (
